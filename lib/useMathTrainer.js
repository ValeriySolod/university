...
import { buildPracticeQuestions, QUANTITY_OPTIONS } from "./practiceQuestions";
...
export function useMathTrainer() {
  ...
  const [difficultyChoice, setDifficultyChoice] = useState(DEFAULT_DIFFICULTY);
  const [quantityChoice, setQuantityChoice] = useState(DEFAULT_QUANTITY);
