...
import { buildPracticeAttempt } from "./attempts";
...
export function useMathTrainer() {
  ...
  const selectAnswer = useCallback(
    (selectedIndex) => {
      ...
      const earnedPoints = scoreQuestion(question, { selectedIndex });
      const isCorrect = earnedPoints === question.pointValue;
