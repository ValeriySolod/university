...
export function useNmtSession() {
  ...
  const toggleCurrentQuestionMark = useCallback(() => {
    toggleMark({ questionId: currentQuestion.id, questionSnapshot: currentQuestion, category: null, sourceAttemptId: null });
  ...
  return {
    ...
    questionRegionRef,
    submitButtonRef,
    isCurrentQuestionMarked: isMarked(currentQuestion.id),
